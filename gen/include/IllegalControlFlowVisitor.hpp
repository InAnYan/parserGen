#ifndef LOX_ILLEGALCONTROLFLOW_HPP
#define LOX_ILLEGALCONTROLFLOW_HPP

#include <Visitor.hpp>

namespace Lox
{
    class IllegalControlFlow : public AST::Visitor
    {
    public:
        IllegalControlFlow();
        ~IllegalControlFlow();
    ...
    }; // class IllegalControlFlow
} // namespace Lox

#endif // LOX_ILLEGALCONTROLFLOW_HPP
